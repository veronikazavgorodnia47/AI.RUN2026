...
|---|---|---|---|
| **S1 — Availability verdict display** | ✓ Primary | ✓ Supporting | Shoppers with an accurate verdict before reserving are less likely to arrive at a phantom-stock situation; direct reduction in cancellation rate |
